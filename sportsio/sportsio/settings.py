"""
Django settings for sportsio project.
...
SECRET_KEY = 'django-insecure-ae5vgmb4yot6+=^utcitmx!8y6w6)e%^@u0s57j=vg8ago@6r*'
...
WSGI_APPLICATION = 'sportsio.wsgi.application'
